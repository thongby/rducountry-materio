          ...
          <Grid item xs={12} sm={6} sx={{ my: 'auto' }}>
            <Box sx={{ mr: 2, display: 'flex', alignItems: 'center' }}>
              ...
              <Box sx={{ display: 'flex', flexDirection: 'column' }}>
                <Typography variant='body2'>จำนวนโรงพยาบาล</Typography>
            ...
            <Grid container>
              <Grid item xs={6} sx={{ mb: 4 }}>
                ...
                <Typography sx={{ fontWeight: 600 }}>15</Typography>
              </Grid>
              <Grid item xs={6} sx={{ mb: 4 }}>
                <Box
                  sx={{
              ...
              <Grid item xs={6}>
                ...
                <Typography sx={{ fontWeight: 600 }}>700</Typography>
              </Grid>
            </Grid>
          </Grid>
        </Grid>
...
export default RDUHospitalOverview
