          ...
          <Grid item xs={12} sm={6} sx={{ my: 'auto' }}>
            <Box sx={{ mr: 2, display: 'flex', alignItems: 'center' }}>
              ...
              <Box sx={{ display: 'flex', flexDirection: 'column' }}>
                <Typography variant='body2'>จำนวนร้านขายยาทั้งหมด</Typography>
            ...
            <Grid container>
              <Grid item xs={6} sx={{ mb: 4 }}>
                ...
                >
                  ...
                  <Typography variant='body2'>ขย.1</Typography>
                </Box>
              ...
              <Grid item xs={6} sx={{ mb: 4 }}>
                ...
                >
                  <Icon icon='mdi:circle' />
                  <Typography variant='body2'>ขย.2</Typography>
                </Box>
                <Typography sx={{ fontWeight: 600 }}>4,900</Typography>
              </Grid>
              <Grid item xs={6}>
                <Box
                  sx={{
                ...
                >
                  <Icon icon='mdi:circle' />
                  <Typography variant='body2'>ขย.3</Typography>
                </Box>
                <Typography sx={{ fontWeight: 600 }}>2,750</Typography>
              </Grid>
              <Grid item xs={6}>
                <Box
                  sx={{
                ...
                >
                  <Icon icon='mdi:circle' />
                  <Typography variant='body2'>ขย.4</Typography>
                </Box>
