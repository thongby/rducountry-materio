...
const ChwCoordList = (props: Props) => {
  ...
  const toggleAddChwCoordDrawer = () => setAddChwCoordOpen(!addChwCoordOpen)
  ...
  return (
    <Grid container spacing={6}>
      ...
      <AddChwCoordDrawer open={addChwCoordOpen} toggle={toggleAddChwCoordDrawer}/>
    </Grid>
  )
}

export default ChwCoordList
