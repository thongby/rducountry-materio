...
const AmpCoordList = (props: Props) => {
  //** State */
  ...
  const toggleAddAmpCoordDrawer = () => setAddAmpCoordOpen(!addAmpCoordOpen)
  ...
  return (
    <Grid container spacing={6}>
      ...
      <AddAmpCoordDrawer open={addAmpCoordOpen} toggle={toggleAddAmpCoordDrawer}/>
    </Grid>
  )
}

export default AmpCoordList
